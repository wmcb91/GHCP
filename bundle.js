...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileUI = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var roundsUI = __webpack_require__(9);
	...
	var hasNoProfiles = function hasNoProfiles() {
	  setTimeout(function () {
	    $('#chooseProfileModal').modal('show');
	  }, 200);
	};

	var hasOneProfile = function hasOneProfile() {
	...
	var hasManyProfiles = function hasManyProfiles() {
	  setTimeout(function () {
	    $('#chooseProfileModal').modal('show');
	  }, 350);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var populateRounds = function populateRounds() {
	  ...
	  for (var i = 0; i < app.profile.rounds.length; i++) {
	    $('.previous-rounds').prepend("<tr class='profile-rounds'><td>" + roundsObject[i].date_played + "</td><td>" + roundsObject[i].course + "</td><td>" + roundsObject[i].rating + "</td><td>" + roundsObject[i].slope + "</td><td>" + roundsObject[i].par + "</td><td>" + roundsObject[i].score + "</td></tr>");
	  }
	};
	...
	var indexRoundsFailure = function indexRoundsFailure(error) {
	...
	module.exports = {
	  ...
	  // indexRoundsSuccess,
	  indexRoundsFailure: indexRoundsFailure,
