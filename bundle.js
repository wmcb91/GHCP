...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileEvents = __webpack_require__(11);
	var roundsEvents = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addRound = function addRound(data) {
	  var newRoundObject = data;
	  $("<tr class='profile-rounds'><td>" + newRoundObject.date_played + "</td><td>" + newRoundObject.course + "</td><td>" + newRoundObject.rating + "</td><td>" + newRoundObject.slope + "</td><td>" + newRoundObject.par + "</td><td>" + newRoundObject.score + "</td></tr>").prependTo('.rounds-row');
	};
	...
	module.exports = {
	  ...
	  createMaxRoundSuccess: createMaxRoundSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileAPI = __webpack_require__(12);
	var ui = __webpack_require__(10);
	var calculations = __webpack_require__(15);
	var app = __webpack_require__(7);
	...
	var getProfileRounds = function getProfileRounds() {
	  profileAPI.showProfile(app.profile.id).done(ui.createRoundSuccess).fail(ui.createRoundFailure);
	};
