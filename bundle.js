...
/***/ function(module, exports, __webpack_require__) {
	...
	var profilesToObject = function profilesToObject() {
	  var profilesObject = app.user.profiles.reduce(function (o, v, i) {
	    o[i] = v;
	    return o;
	  }, {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reverseRoundsToObject = function reverseRoundsToObject() {
	  var reverseRoundsObject = app.profile.rounds.reverse().reduce(function (o, v, i) {
	    o[i] = v;
	    return o;
	  }, {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDeleteProfileConfirm = function onDeleteProfileConfirm(event) {
	  event.preventDefault();
	  var id = app.profile.id;
	  api.destroyProfile().done(ui.deleteProfileSuccess).fail(ui.deleteProfileFailure);
	  setTimeout(function () {
	    $(authAPI.getUser(id).done(authUI.updateUserProfiles, ui.populateProfiles));
	  }, 75);
	  setTimeout(function () {
	    $(ui.clearProfiles());
	  }, 125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var editProfile = function editProfile(data) {
	  return $.ajax({
	    url: app.host + '/change-password/' + app.user.id,
	    method: 'PATCH',
	    headers: {
